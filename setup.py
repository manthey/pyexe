...
setup(
    console=[{
        ...
        'other_resources': [(
            py2exe.resources.VersionInfo.RT_VERSION, 1, py2exe.resources.VersionInfo.Version(
                ...
                legal_copyright='Copyright 2013, 2014i, 2018 David Manthey',
    ...
    options={
        'py2exe': {
            ...
            'compressed': True,
            # If we turn on optimizations, then some things, such as sympy,
            # which depend on docstring manipulation will fail
            # 'optimize': 2,

            # These dll_excludes were recommends to allow psutil to work, but
            # it doesn't help
